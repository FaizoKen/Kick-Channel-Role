...
//!
//! Construction:
//!   * KEK = HKDF-SHA256(SESSION_SECRET, salt=fixed, info="kick-channel-role/v1/kek")
...
const HKDF_INFO: &[u8] = b"kick-channel-role/v1/kek";
const HKDF_SALT: &[u8] = b"kick-channel-role/v1/salt";
const AAD: &[u8] = b"kick-channel-role/v1/oauth-token";
